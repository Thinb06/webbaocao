(function() {
    const translations = {
        ...
        'Nhập THEMAN50 hoặc KM10': 'Enter THEMAN50 or KM10',
        'Áp dụng': 'Apply',
        'Tạm tính:': 'Subtotal:',
        ...
        'Điện thoại': 'Phone',
        'Địa chỉ': 'Address',
        'Nhận liền tay khuyến mãi hôm nay. Nhập mã THEMAN50 để giảm 50k và mã KM10 để giảm 10% cho tất cả sản phẩm có trong cửa hàng !!': 'Get today offer now. Use THEMAN50 for 50K off or KM10 for 10% off all products in store!',
        'THE MAN. STUDIO mang đến những sản phẩm thời trang nam đơn giản, hiện đại và dễ phối đồ.': 'THE MAN. STUDIO offers simple, modern, and easy-to-style men fashion products',
        ...
        if (oldHeader) {
            oldHeader.outerHTML = `${header}
                <div class="promo-announcement" role="status">
                    <span class="promo-announcement-text">Nhận liền tay khuyến mãi hôm nay. Nhập mã THEMAN50 để giảm 50k và mã KM10 để giảm 10% cho tất cả sản phẩm có trong cửa hàng !!</span>
                </div>`;
        }
        translatePage();
    });
